...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst create_element_1 = __webpack_require__(/*! ../../../utils/create-element */ \"./src/utils/create-element.ts\");\nconst props_1 = __webpack_require__(/*! ../../../models/props */ \"./src/models/props.ts\");\nconst event_1 = __webpack_require__(/*! ../../../models/event */ \"./src/models/event.ts\");\nconst constants_1 = __webpack_require__(/*! ../../../constants */ \"./src/constants.ts\");\nclass MiniMap {\n    constructor(domain) {\n        this.domain = domain;\n    }\n    render() {\n        const canvas = create_element_1.default('canvas', 'minimap', [\n            'position: absolute',\n        ]);\n        canvas.width = this.domain.width;\n        canvas.height = this.domain.height;\n        const context = canvas.getContext('2d');\n        context.fillStyle = 'rgba(180, 180, 255, 1)';\n        const maxHeight = this.domain.height - constants_1.DATE_BAR_HEIGHT;\n        let height = maxHeight / props_1.default.config.rowCount;\n        if (height < 1)\n            height = 1;\n        for (let i = 0; i < props_1.default.config.events.length; i++) {\n            const event = new event_1.default(props_1.default.config.events[i], this.domain);\n            const y = maxHeight - ((event.row + 1) * height);\n            const width = event.width < 1 ? 1 : event.width;\n            context.fillRect(event.left, y, width, height);\n        }\n        return canvas;\n    }\n}\nexports.default = MiniMap;\n\n\n//# sourceURL=webpack://Timeline/./src/views/band/minimap/index.ts?");
