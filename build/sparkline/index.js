...
const Sparkline = (props) => {
    if (props.aggregate.length > props.width)
        return null;
    ...
    const pathCloser = ` L ${props.width + 1} ${constants_1.DATE_BAR_HEIGHT + 1} L -1 ${constants_1.DATE_BAR_HEIGHT + 1}`;
    return (React.createElement("svg", { style: {
            position: 'absolute',
            bottom: 0,
        }, viewBox: `0 0 ${props.width} ${constants_1.DATE_BAR_HEIGHT}` },
